...
Wave 0 foundations (branch `wave-0/foundations`, 2026-09-20/24): backend lint backlog cleared (BL-37 part 1), reproducible doc generators (BL-66), migration test harness (BL-65), read-only BL-62 dry-run (`npm run migration:dry-run`) and the draft existing-school migration strategy (`docs/database/MIGRATION-STRATEGY.md`, awaiting approval).

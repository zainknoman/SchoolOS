...
describe('normalizeIdentifier', () => {
  ...
  it.each(['+92 300 1234567', '0092-300-1234567', '923001234567', '0300 1234567', '(0300) 123-4567'])(
    'canonicalises phone %s',
    (input) => expect(normalizeIdentifier(input)).toBe('03001234567'),
  );

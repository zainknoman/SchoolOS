...
|---|---|---|
| Backend unit (`backend/src/**/*.spec.ts`) | 98 | 711 |
| Backend e2e (`backend/test/*.e2e-spec.ts`) | 47 | 340 |
| Staff console (`staff-console/src/**/*.spec.ts`) | 80 | 549 |
...
| `app.e2e-spec.ts` | 1 |
| `archive-retention.e2e-spec.ts` | 10 |

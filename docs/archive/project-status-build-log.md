> **ARCHIVED 2026-09-20** — Chronological build log. Current status: PROJECT-STATUS.md. Contains stale items (e.g. 'SQLite→PostgreSQL pending'). Do not treat as current documentation.

...
## 0. Progress and handoff (updated 2026-09-26, after BL-41)
...
| 4 | BL-41 (audited CSV export) | ✅ | (this commit) |
| 5 | BL-26 · BL-27 · BL-06 · BL-28 · BL-29 (M1b) | ⏭ **next** (BL-26 first) | — |
...
- Last verified counts (2026-09-26, BL-41): backend unit 743, e2e 314 (42 suites), harness 10 scenarios + 13 tests (unchanged), console 549, parent app 110 (unchanged).
...
**Next step:** Wave 5 — BL-26 (syllabus), then BL-27 (grading scales), BL-06 (report-card generation), BL-28 (risk settings), BL-29 (leave workflow, migration M1b). The M10 additive schema changes for BL-26/27/06/28 land with their items.

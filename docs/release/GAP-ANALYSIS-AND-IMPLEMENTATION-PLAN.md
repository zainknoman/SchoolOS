...
**Progress (updated 2026-09-26 after BL-28, branch `wave-0/foundations`)** — delivered since this table was written (✅ = done, commit in EXECUTION-PLAN §0):

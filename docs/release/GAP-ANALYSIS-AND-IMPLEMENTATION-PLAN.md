...
**Progress (updated 2026-09-26 after BL-26, branch `wave-0/foundations`)** — delivered since this table was written (✅ = done, commit in EXECUTION-PLAN §0):
...
- ✅ Wave 5 so far: BL-26 yearly syllabus per class + subject (admins edit, teachers of the class read, copied by copy-structure, ended sessions read-only). Next: BL-27, BL-06, BL-28, BL-29, then Waves 6–7.

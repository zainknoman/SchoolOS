...
- The BL-62 strategy ([MIGRATION-STRATEGY](../database/MIGRATION-STRATEGY.md), approved 2026-09-24) is required before session/subject/fee/guardian/lifecycle migrations run; run `npm run migration:dry-run -- --url <production copy>` and resolve blocking review rows first (§8 of that document).

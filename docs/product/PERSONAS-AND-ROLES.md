...
| Admissions (applicants, applications, approve/reject) | ✔ | ✔ | ✔ (create/list/decide) | — | — |
...
| Complaints | C/U/R | C/U/R | C/U/R | C/U/R (section-scoped) | R own child only (read-only screen) |
| Leave requests | A (approve/reject) + R | A + R | — | — | C + R own |
| Fee structures | CRU | CRU | CRU | — | — |
| Fee vouchers & reconcile | ✔ | ✔ | ✔ | — | pay (`/pay`) + R child |
| Messages (conversations) | R/reply | R/reply | R/reply | R/reply (class teacher) | C + R + reply |

...
> **Status of decided items:** leave recommendations (BL-29) and attendance-risk alerts with per-school thresholds (BL-28) are live. This guide describes current behaviour.

| Task | Where | Notes |
|---|---|---|
| See today at a glance | **My Day** | your periods and to-dos |
| See your week | **Timetable** | read-only; the administrator edits timetables |
| Take attendance | **Attendance** | choose section and date; mark Present / Absent / Late / Leave for each student (bulk save). **Not allowed** on a declared holiday; the system records you as the one who marked it |
...
- You cannot approve or reject leave (school admins decide; you recommend), edit the timetable, or see other teachers' sections.
